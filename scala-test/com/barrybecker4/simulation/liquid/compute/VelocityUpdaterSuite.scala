...
/* not working yet
  test("UpdateInAbsenceOfFlow") {
    ...
    cell.swap()
    assertEquals(new Vector2d(0.0, 1.0), new Vector2d(cell.getU, cell.getV), "Unexpected UV")
  }
  ...
  test("UpdateInSlightNorthEastFlow") {
    ...
    velocityUpdater.updateTildeVelocities(cell, neighbors, grid.getCell(1, 3), grid.getCell(3, 1), DT, FORCE, VISCOSITY)
    cell.swap()
    assertEquals(new Vector2d(0.1, 1.1), new Vector2d(cell.getU, cell.getV), "Unexpected UV")
  }
  ...
  test("UpdateInSlightNorthEastNonUniformFlow") {
    ...
    velocityUpdater.updateTildeVelocities(cell, neighbors, grid.getCell(1, 3), grid.getCell(3, 1), DT, FORCE, VISCOSITY)
    cell.swap()
    assertEquals(new Vector2d(0.057110615322103674, 1.0571106153221037), new Vector2d(cell.getU, cell.getV), "Unexpected UV")
  }
  ...
  test("UpdateInSlightNothEastFlowFlowUpperLeftTweak")  {
    ...
    velocityUpdater.updateTildeVelocities(cell, neighbors, grid.getCell(1, 3), grid.getCell(3, 1), DT, FORCE, VISCOSITY)
    cell.swap()
    assertEquals(new Vector2d(0.1, 1.0997500000000002), new Vector2d(cell.getU, cell.getV), "Unexpected UV")
  }
  ...
  test("UpdateInSlightNorthEastFlowFlowLoweRightTweak")  {
    ...
    velocityUpdater.updateTildeVelocities(cell, neighbors, grid.getCell(1, 3), grid.getCell(3, 1), DT, FORCE, VISCOSITY)
    cell.swap()
    assertEquals(new Vector2d(0.09975, 1.1), new Vector2d(cell.getU, cell.getV), "Unexpected UV")
  }
  ...
  test("UpdateInSlightNorthEastFlowFlowLeftPressureTweak") {
    ...
    velocityUpdater.updateTildeVelocities(cell, neighbors, grid.getCell(1, 3), grid.getCell(3, 1), DT, FORCE, VISCOSITY)
    cell.swap()
    assertEquals(new Vector2d(0.10450000000000001, 1.1), new Vector2d(cell.getU, cell.getV), "Unexpected UV")
  }
  ...
  test("UpdateInSlightNorthEastFlowFlowLowerPressureTweak") {
    ...
    velocityUpdater.updateTildeVelocities(cell, neighbors, grid.getCell(1, 3), grid.getCell(3, 1), DT, FORCE, VISCOSITY)
    cell.swap()
    assertEquals(new Vector2d(0.1, 1.1045), new Vector2d(cell.getU, cell.getV), "Unexpected UV")
  }*/
}
